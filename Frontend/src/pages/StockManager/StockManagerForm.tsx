...
const StockManagerForm = () => {
  return (
    <Card>
      <CardHeader>
        <CardTitle>Create New Stock Manager</CardTitle>
      </CardHeader>
      <CardContent>
        <div className="flex flex-col gap-5">
          <div className="flex flex-col gap-5 md:flex-row md:justify-center md:gap-25 lg:gap-32 xl:gap-45">
            <div className="flex flex-col gap-2">
              <Label className="text-right"> Stock manager name</Label>
